    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-950 px-4">
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center shadow-2xl">
        ...
        <p className="text-sm text-gray-400 mb-6 leading-relaxed">
          TubeAuto needs access to your YouTube channel to automatically upload
        ...
        <ul className="text-left space-y-3 mb-8">
          {PERMISSIONS.map((perm) => (
            <li key={perm} className="flex items-center gap-3">
              <span className="w-5 h-5 rounded-full bg-green-900/50 border border-green-600 flex items-center justify-center shrink-0">
                <svg
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white hover:bg-gray-100 text-gray-900 text-sm font-semibold rounded-xl transition-colors shadow"
        >
